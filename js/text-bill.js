...
//            billTotal1 += 0.75;
  //          smsTotal1 += 0.75;
    ...
    callT.innerHTML = (textX.totalForCalls1()).toFixed(2);
    smsT.innerHTML = (textX.totalForSms1()).toFixed(2);

    //total.innerHTML = billTotal1.toFixed(2);
  //  textX.executedTotal1()
    total.innerHTML = textX.executedTotal1().toFixed(2);
    styleTotal();
}
...
function styleTotal(){
    ...
    if (textX.executedTotal1() >= 50) {
        // make the total red
        total.classList.add('danger')
    } else if (textX.executedTotal1() >= 30 && textX.executedTotal1() < 50) {
